...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAFC]">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#171717] to-[#171717] text-[#F8FAFC] py-16">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <h1 className="text-5xl font-bold mb-6">About Yomnoo</h1>
          <p className="text-xl text-[#F8FAFC]/85 leading-relaxed max-w-3xl mx-auto">
      ...
      <div className="container mx-auto px-4 max-w-4xl py-12">
        ...
        <section className="mb-12 border-y border-[#451e84]/15 py-9">
          <div className="grid gap-8 md:grid-cols-[220px_minmax(0,1fr)] md:items-start">
            <div>
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[#451e84] text-white">
            ...
            <div className="space-y-4 text-base leading-7 text-gray-700">
              ...
              <Link href="/local-pickup" className="inline-flex font-semibold text-[#171717] hover:text-[#361668] hover:underline">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#451e84]/10 p-8 mb-12">
          <div className="mb-6">
          ...
          <div className="space-y-6">
            <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#451e84]/10 border-l-4 border-l-[#171717]">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-[#451e84] text-[#F8FAFC] rounded-full flex items-center justify-center font-bold text-lg">
                  1
                </div>
                <div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#451e84]/10 p-8 mb-12">
          <div className="flex items-center gap-4 mb-6">
            <div className="p-3 bg-[#451e84]/10 rounded-xl">
              <Users className="h-8 w-8 text-[#171717]" />
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-[#F8FAFC] rounded-lg p-4 border border-[#451e84]/10">
              <CheckCircle2 className="h-6 w-6 text-[#171717] mb-2" />
              <p className="text-gray-700 font-medium">verifying authentic condition</p>
            </div>
            <div className="bg-[#F8FAFC] rounded-lg p-4 border border-[#451e84]/10">
              <Zap className="h-6 w-6 text-[#171717] mb-2" />
              <p className="text-gray-700 font-medium">confirming that the product works perfectly</p>
            </div>
            <div className="bg-[#F8FAFC] rounded-lg p-4 border border-[#451e84]/10">
              <DollarSign className="h-6 w-6 text-[#171717] mb-2" />
              <p className="text-gray-700 font-medium">validating that the price reflects real market value</p>
            </div>
          </div>

          <p className="text-gray-700 mb-6 bg-[#F8FAFC] rounded-lg p-4 border border-[#451e84]/10">
            Only after the inspection is complete does the item become available for purchase.
          </p>

          <div className="bg-[#F8FAFC] rounded-lg p-6 border border-[#451e84]/10">
        ...
        {/* Our Mission */}
        <div className="bg-gradient-to-r from-[#171717] to-[#171717] rounded-2xl shadow-lg p-10 mb-12 text-[#F8FAFC] text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#451e84]/15 rounded-full mb-6">
            <Target className="h-8 w-8" />
          </div>
          <h2 className="text-3xl font-bold mb-4">Our Mission</h2>
          <p className="text-xl text-[#F8FAFC]/85 mb-4">
            To give everyday shoppers access to high quality products at honest prices.
          </p>
          <p className="text-lg text-[#F8FAFC]/85">
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#451e84]/10 p-8 mb-12">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-[#451e84] rounded-xl">
              <Sparkles className="h-8 w-8 text-[#171717]" />
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#451e84]/10">
              <div className="flex items-center gap-3 mb-3">
                <Eye className="h-6 w-6 text-[#171717]" />
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#451e84]/10">
              <div className="flex items-center gap-3 mb-3">
                <Headphones className="h-6 w-6 text-[#171717]" />
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#451e84]/10 md:col-span-2">
              <div className="flex items-center gap-3 mb-3">
                <Leaf className="h-6 w-6 text-[#171717]" />
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-[#451e84]/10 p-8 mb-12">
          <div className="flex items-center gap-4 mb-8">
            <div className="p-3 bg-[#451e84] rounded-xl">
              <Heart className="h-8 w-8 text-[#171717]" />
            </div>
            <h2 className="text-3xl font-bold text-[#262626]">Our Values</h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-[#F8FAFC] rounded-xl p-6 text-center border border-[#451e84]/10">
              <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-[#451e84]">
                <Shield className="h-8 w-8 text-[#171717]" />
              </div>
              <h3 className="font-bold text-[#262626] text-lg">Integrity</h3>
            </div>
            <div className="bg-[#F8FAFC] rounded-xl p-6 text-center border border-[#451e84]/10">
              <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-[#451e84]">
                <Award className="h-8 w-8 text-[#171717]" />
              </div>
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-6 text-center border border-[#451e84]/10">
              <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-[#451e84]">
                <Zap className="h-8 w-8 text-[#171717]" />
              </div>
        ...
        {/* Company Stats */}
        <div className="bg-gradient-to-r from-[#171717] to-[#171717] rounded-2xl shadow-lg p-10 mb-12 text-[#F8FAFC]">
          <h3 className="text-3xl font-bold mb-8 text-center">Company Stats</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-6 bg-[#F8FAFC]/10 backdrop-blur-sm rounded-xl border border-[#F8FAFC]/20">
              <div className="text-4xl font-bold mb-2">5000+</div>
              <div className="text-[#F8FAFC]/80 text-sm">happy customers</div>
            </div>
            <div className="text-center p-6 bg-[#F8FAFC]/10 backdrop-blur-sm rounded-xl border border-[#F8FAFC]/20">
              <div className="text-4xl font-bold mb-2">1000+</div>
              <div className="text-[#F8FAFC]/80 text-sm">products sold</div>
            </div>
            <div className="text-center p-6 bg-[#F8FAFC]/10 backdrop-blur-sm rounded-xl border border-[#F8FAFC]/20">
              <div className="text-4xl font-bold mb-2">99%</div>
              <div className="text-[#F8FAFC]/80 text-sm">satisfaction rate</div>
            </div>
            <div className="text-center p-6 bg-[#F8FAFC]/10 backdrop-blur-sm rounded-xl border border-[#F8FAFC]/20">
              <div className="text-4xl font-bold mb-2">24/7</div>
              <div className="text-[#F8FAFC]/80 text-sm">support available</div>
            </div>
          </div>
        </div>

        {/* Contact Information */}
        <div className="bg-white rounded-2xl shadow-lg border border-[#451e84]/10 p-8">
          <div className="flex items-center gap-4 mb-6">
            <div className="p-3 bg-[#451e84]/10 rounded-xl">
              <MessageSquare className="h-8 w-8 text-[#171717]" />
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#451e84]/10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="font-medium text-[#262626]">Warehouse Location</div>
              </div>
            ...
            <div className="bg-[#F8FAFC] rounded-xl p-6 border border-[#451e84]/10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="font-medium text-[#262626]">Live Support</div>
              </div>
